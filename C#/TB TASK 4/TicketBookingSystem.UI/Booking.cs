...
namespace TicketBookingSystem.UI
{
	class Booking
	{
		static void Main(string[] args)
		{
			...
			eventobj.eventName = "Anisha's India Tour";
			...
			venueobj.venueName = "Codisia ";
			venueobj.venueAddress = "Coimbatore,TamilNadu,India";

			CustomerRepository customerRepository = new CustomerRepository();
			CustomerService customerService = new CustomerService(customerRepository);

			customerobj.customerName = "Anisha";
			customerobj.email = "anishak@gmail.com";
			...
			while (choice != 10)
			{
				...
				switch (choice)
				{
					...
					case 6:
						...
						{
							Console.WriteLine("seats are filled completely");
							Console.WriteLine("Try booking yours seats fast next time");
						}
						else
						{
